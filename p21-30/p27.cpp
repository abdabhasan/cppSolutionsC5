...
// from 1 to 100, then print average of all numbers;
...
float averageOfArrayElements(int arr[100], int arrLength){
...
int main(){
    ...
    cout << "Sum : " << sumOfArrayElements(arr, arrLength) << endl;

    cout << "Average : " << averageOfArrayElements(arr, arrLength);
